...
def universal_setup() -> None:
    ...
    shutil.copyfile(CORE_UTILS_TEST_FILES_FOLDER / "1_raw.txt", TEST_PATH / "1_raw.txt")
    shutil.copyfile(CORE_UTILS_TEST_FILES_FOLDER / "1_meta.json", TEST_PATH / "1_meta.json")
